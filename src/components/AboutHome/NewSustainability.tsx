...
const NewSustainability: React.FC = () => {
  ...
  return (
    <div className="relative w-full p-8 bg-white lg:h-[90vh] h-[100vh] overflow-hidden">
      <h2 className="lg:text-5xl text-2xl font-bold text-[#3a2a79] mb-8 top-[10] font-poppins ">
                  ...
                  <Card>
                    <CardContent className="flex aspect-square items-center justify-center lg:p-5 ">
                      <div className="flex flex-col lg:mb-[20rem] lg:mr-10">
                        <h3 className="lg:text-3xl relative lg:text-black text-[#138808] -top-7 lg:top-0 font-poppins font-bold text-center lg:p-0 lg:text-left w-full text-2xl">
                          {slide.title}
                        </h3>
