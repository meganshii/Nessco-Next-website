...
const PinkCity = () => {
  ...
  return (
    <div className="relative mx-auto lg:h-[90vh] h-full bg-white w-screen">
      <h1 className="lg:text-5xl text-3xl font-bold text-left relative top-[5vh] font-poppins text-[#312465] lg:ml-10 ml-4">
        {galleryfour.heading}
      </h1>
            ...
            {!isMobile ? (
              <div className="group relative h-full w-full overflow-hidden">
                ...
                <div className=" absolute left-20 lg:left-0 inset-0 flex flex-col items-center justify-center lg:transition-transform lg:duration-300 lg:transform lg:translate-y-full lg:group-hover:translate-y-0">
                  ...
                  />
                  <p className="text-white -mt-20 lg:text-sm font-bold lg:w-[15rem] text-xs w-35vw] text-center font-poppins">
                    {item.paragraph}
                  </p>
                  <Image
                  ...
                  />
                  <p className=" lg:visible invisible text-white font-poppins underline decoration-white -mt-16">
                    Read More
                  </p>
                </div>
              </div>
