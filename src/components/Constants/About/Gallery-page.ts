...
export const images = [
    ...
    { src: '/assets/about/oldwomen.jpg', alt: 'Image 6', style: ' lg:visible invisible lg:top-[70%] top-[79%] lg:left-[8%] left-[10%] lg:w-[6%] lg:h-[19%] w-[19%] h-[11%]' },
    { src: '/assets/about/palace.jpeg', alt: 'Image 7', style: '  lg:top-[57%] top-[75%] left-[56%] lg:w-[15%] lg:h-[15%] w-[33%] h-[12%] image-translate-up' },
    { src: '/assets/about/wheel.jpg', alt: 'Image 8', style: 'lg:top-[75%] lg:left-[68%] lg:w-[7%] lg:h-[12%] h-[7%] w-[20%] top-[82%] left-[24%]' },
