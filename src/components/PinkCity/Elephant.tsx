...
import styles from './secondpage.module.css'; // Import the CSS module
import { gsap } from 'gsap';
import { ScrollTrigger } from 'gsap/ScrollTrigger';

const DashedLineWithImage = () => {
  const dashedLineRef = useRef<HTMLDivElement | null>(null);
  const svgImageRef = useRef<HTMLDivElement | null>(null);
  ...
  return (
    <div className="absolute lg:-mt-80 lg:right-14  flex flex-col items-center z-10 mt-[20rem]">
      <div
        ref={dashedLineRef}
     ...
     <div
      ...
      >
        <Image
          src="/assets/pinkcity/elephantimg.svg" // Update with your SVG image path
          alt="Elephant"
